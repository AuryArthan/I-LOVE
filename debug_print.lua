...
-- potential attacks print
function DebugPr:potential_attacks_print(posx, posy)
	love.graphics.print("Potential attacks", posx, posy)
	for p=1,4 do
		love.graphics.print(" Player "..p..": ", posx, posy+p*13)
		if Board.PlayerAlive[p] == 1 then
			love.graphics.print(Player:potential_attacks(p, Board), posx+64, posy+p*13)
		end
	end
end
...
function DebugPr:legal_moves(posx, posy)
	...
	local moves = Board:list_legal_moves()
...
-- legal moves print
function DebugPr:move_scores(posx, posy)
	love.graphics.print("Move scores: ", posx, posy)
	local active_player = Board.Turn
	local moves = Board:list_legal_moves()				-- legal moves
	local scores = {}
	...
	for i,m in ipairs(moves) do
		love.graphics.print("("..moves[i][1][1]..","..moves[i][1][2].. ")-("..moves[i][2][1]..","..moves[i][2][2].."): "..scores[i], posx, posy+7*i)
	end
end
